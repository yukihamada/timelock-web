const I18N = {
  ja: {
    ...
    usecase_label: "用途",
    usecases: [
      { id: "capsule", name: "🕰 タイムカプセル", ms: 365 * 86400e3, tip: "未来の自分や誰かへ。指定日まで誰も開けません。" },
      { id: "bid", name: "📩 封印入札 / commit-reveal", ms: 7 * 86400e3, tip: "締切まで中身を秘匿。入札・予測・コンペの公正性を担保（全員が締切後に一斉開封）。" },
      { id: "embargo", name: "📰 エンバーゴ公開", ms: 86400e3, tip: "プレス・脆弱性開示などを「X時に一斉解禁」。事前に配っても時刻前は開けません。" },
      { id: "deadman", name: "🔐 デッドマンスイッチ / 遺言", ms: 30 * 86400e3, tip: "「その時が来たら開く」メッセージ。合言葉を付けると相手も限定できます。" },
    ],
    msg_label: "メッセージ", msg_ph: "ここに秘密のメッセージを入力…",
    unlock_label: "解錠時刻（この時刻まで開けません）",
    pass_label: "合言葉（任意・付けると「時刻＋合言葉」で開封）",
    pass_ph: "空欄なら時刻だけで開封できます",
    pass_hint: "⚠ 合言葉は暗号文に含まれません。相手に別経路で伝えてください。忘れると復号できません。",
    enc_btn: "この時刻まで封印する",
    ct_label: "暗号文（この全文を相手に渡してください）",
    copy: "📋 コピー", copy_link: "🔗 リンク", download: "💾 .txt保存",
    copied: "✓ コピーしました", link_copied: "✓ リンクをコピー",
    link_too_long: "暗号文が長すぎてリンク化できません（本文をお使いください）",
    ct_in_label: "暗号文を貼り付け",
    ct_in_ph: "-----BEGIN AGE ENCRYPTED FILE----- …",
    pass_in_label: "合言葉", pass_in_ph: "この暗号文には合言葉が必要です",
    need_pass: "この暗号文には合言葉が必要です。入力して再度復号してください。",
    bad_pass: "合言葉が違います。",
  ...
  en: {
    ...
    usecases: [
      { id: "capsule", name: "🕰 Time capsule", ms: 365 * 86400e3, tip: "For your future self or someone else. No one can open it before the date." },
      { id: "bid", name: "📩 Sealed bid / commit-reveal", ms: 7 * 86400e3, tip: "Keep contents secret until a deadline — fair auctions, predictions, contests (everyone reveals after the deadline)." },
      { id: "embargo", name: "📰 Embargoed release", ms: 86400e3, tip: "Release a press item or vulnerability disclosure at exactly time X. Hand it out early; it stays sealed until then." },
      { id: "deadman", name: "🔐 Dead man's switch / will", ms: 30 * 86400e3, tip: "A message that opens 'when the time comes'. Add a passphrase to also restrict the recipient." },
    ],
    msg_label: "Message", msg_ph: "Type your secret message…",
    unlock_label: "Unlock time (cannot be opened before this)",
    pass_label: "Passphrase (optional — requires time AND passphrase to open)",
    pass_ph: "Leave empty to open with time alone",
    pass_hint: "⚠ The passphrase is NOT stored in the ciphertext. Share it via a separate channel. If lost, it cannot be decrypted.",
    enc_btn: "Seal until this time",
    ct_label: "Ciphertext (give this whole text to the recipient)",
    copy: "📋 Copy", copy_link: "🔗 Link", download: "💾 Save .txt",
    copied: "✓ Copied", link_copied: "✓ Link copied",
    link_too_long: "Ciphertext too long to make a link (use the text instead)",
    ct_in_label: "Paste ciphertext",
    ct_in_ph: "-----BEGIN AGE ENCRYPTED FILE----- …",
    pass_in_label: "Passphrase", pass_in_ph: "This ciphertext requires a passphrase",
    need_pass: "This ciphertext requires a passphrase. Enter it and decrypt again.",
